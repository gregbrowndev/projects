...
class Weather(Producer):
    ...
    def run(self, month):
        ...
        print(f"producing weather to {self.topic_name}")
           ...
           data=json.dumps(
               {
                   ...
                   "records": [
                       # Note: serialising status using enum name rather than 'coded' value
                       #  since it is easier to use the name downstream
                       {
