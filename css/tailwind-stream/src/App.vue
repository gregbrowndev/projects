    ...
    <div id="app" class="min-h-screen bg-gray-200 antialiased">
        ...
        <section class="flex justify-between bg-gray-800 px-4 py-3">
            <div class="relative">
                ...
                <input class="bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg pl-10 pr-4 py-2"
        ...
        <main class="px-4 py-6">
            ...
            <p class="text-gray-600">Live like the stars in these luxurious
                    ...
                    <div class="px-4 -mt-16 relative">
                        <div class="bg-white rounded-lg p-4 shadow-lg">
                            <div class="inline-flex items-center">
                                <span class="inline-block px-2 py-1 leading-none bg-teal-200 text-teal-800 text-xs font-semibold rounded-full uppercase tracking-wide">Plus</span>
